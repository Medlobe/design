        ...
        <div className="image-profile-image-sett">
          <div className="left-tt">
            ...
            <label htmlFor="file-input">
             {userData.profileImage ? <span>change image</span> : <span>select image</span> }
            </label>
            <input
              type="file"
              accept="image/*"
              id="file-input"
              style={{ display: "none" }}
              onChange={handleImageUpload} // This function will handle the file selection
            />
          </div>
          ...
          {preview && (
            <a className="submit-btn-ups" onClick={updateProfileImage}>
              Upload
